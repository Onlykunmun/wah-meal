...
class RdataTB {
    ...
    Control() {
        ...
        <tr>
          <td style="width:100%;">
             <select id="my-select" class="form-select shadow-none" style="float:left;width:80px!important;margin-right:10px;">
             <option value="5">5</option><option value="7">7</option><option value="10">10</option><option value="20">20</option><option value="50">50</option>
             </select>
             <input id="SearchControl" class="form-control shadow-none" placeholder="Search" type="text" style="width:65%;margin-left:10px">
          </td>
        </tr>
      </table>
        `;
