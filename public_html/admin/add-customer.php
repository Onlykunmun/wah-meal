...
if($result_check->num_rows == 0)
{
      ...
      $sql = "INSERT INTO `customers` SET `fullname`= '$fullname', `email` = '$email', `phone` = '$mobileno', 
      `password` = '$password', `lat` = '$lat', `lng` = '$lng', `city` = '$city', `pin` = '$pin',
      `address` = '$address', `created_by` = 'ADMIN', `is_active` = '1', `active_otp` = '1234' ";
            ...
            <div class="col-md-12">
                <div class="card ">
                    <div class="card-footer">
                          <button disabled id="add-customer" name="add-customer" type="submit" class="btn btn-fill btn-rose btn-block">Add Customer</button>
                    </div>
                </div>
            </div>
