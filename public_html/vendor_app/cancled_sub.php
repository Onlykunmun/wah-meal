				        ...
				        <div class="app-card app-card-chart h-100 shadow-sm">
					        <div class="app-card-header p-3">
						        <div class="row justify-content-between align-items-center">
							        <div class="col-auto">
						                <h4 class="app-card-title"><span class="badge bg-danger">canceled Subscription <span class="badge bg-info"><?php echo $cancled_subscription; ?></span></span> </h4> 
							        </div><!--//col-->
...
$sql_subscription = "SELECT * FROM order_subscription WHERE vendor_id = '".$_SESSION["userdata"]["id"]."' AND is_paid = 1 AND accept_reject = 2  ORDER BY subscription_date DESC ";
if($result_subscription = $conn->query($sql_subscription))
{
while($row_subscription = $result_subscription->fetch_assoc()) {
	...
	if($row_subscription['reject_by'] == 1)
	{
		$reject_by = "Customer";
	}
	if($row_subscription['reject_by'] == 2)
	{
		$reject_by = "Vendor";
	}
		if($row_subscription['reject_by'] == 3)
	{
		$reject_by = "Admin";
	}
						    ...
						    <div class="app-card-body p-3 has-card-actions">
							    ...
							    <div class="app-doc-meta">
								    <ul class="list-unstyled mb-0">
										...
										<li><span class="text-muted">Canceled By:</span> <?php echo $reject_by; ?></li>
