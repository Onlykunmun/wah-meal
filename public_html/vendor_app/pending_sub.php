				        ...
				        <div class="app-card app-card-chart h-100 shadow-sm">
					        <div class="app-card-header p-3">
						        <div class="row justify-content-between align-items-center">
							        <div class="col-auto">
						                <h4 class="app-card-title"><span class="badge bg-warning">Pending Subscription <span class="badge bg-danger"><?php echo $pending_subscription; ?></span></span> </h4> 
							        </div><!--//col-->
...
$sql_subscription = "SELECT * FROM order_subscription WHERE vendor_id = '".$_SESSION["userdata"]["id"]."' AND is_paid = 1 AND accept_reject = 0 AND end_date > '$date_of_today' ORDER BY subscription_date DESC ";
if($result_subscription = $conn->query($sql_subscription))
{
while($row_subscription = $result_subscription->fetch_assoc()) {
...
?>
						    ...
						    <div class="app-card-body p-3 has-card-actions">
							    ...
							    <div class="app-doc-meta">
								    <ul class="list-unstyled mb-0">
								        ...
								        <li><span class="text-muted">**Order Amount of ₹ <?php echo $row_subscription['subscription_price']; ?> to be collected before/while accepting this order.</span></li>
			  ...
			  <path fill-rule="evenodd" d="M9.5 13a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0zm0-5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0zm0-5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0z"/>
									    ...
									    <ul class="dropdown-menu">
											...
											<li>
												<form method="post" >
												<button type="submit" name="accept" value="<?php echo $row_subscription['id']; ?>" class="dropdown-item" href="#"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-download me-2" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
	  ...
	  <path fill-rule="evenodd" d="M7.646 11.854a.5.5 0 0 0 .708 0l3-3a.5.5 0 0 0-.708-.708L8.5 10.293V1.5a.5.5 0 0 0-1 0v8.793L5.354 8.146a.5.5 0 1 0-.708.708l3 3z"/>
											...
											<li>
											<form method="post">
											<button type="submit" name="reject" value="<?php echo $row_subscription['id']; ?>" class="dropdown-item" href="#"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-trash me-2" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
