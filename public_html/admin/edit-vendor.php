...
if(isset($_POST['edit-vendor']))
      ...
      if($_FILES["profile-pic"]["name"]!=""){
        ...
        {
          $data_image =  $_POST['pre-profile-pic'];
        }
      ...
      $is_available = $_POST['is_available'];
        ...
        if(strlen($_POST['password']) > 0)
        {
      $sql = "UPDATE `vendors` SET `fullname`= '$fullname', `email` = '$email', `phone` = '$mobileno', 
      ...
      `business_address` = '$business_address', is_available = '$is_available', `business_caption` = '$business_caption' WHERE `id` = '$vendor_edit' ";
        }
        else
        {
          $sql = "UPDATE `vendors` SET `fullname`= '$fullname', `email` = '$email', `phone` = '$mobileno', 
           `lat` = '$lat', `lng` = '$lng', `logo` = '$data_image', 
          `business_name` = '$business_name', `business_city` = '$business_city', `business_pin` = '$business_pin',
          `business_address` = '$business_address', is_available = '$is_available', `business_caption` = '$business_caption' WHERE `id` = '$vendor_edit' ";
        }
    ...
    $sql = "SELECT * FROM `vendors` WHERE `id` = '$vendor_edit'";
              ...
              <div class="card ">
                ...
                <div class="card-body ">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="businessname" value="<?php echo $row['business_name']; ?>" required>
                    </div>
                    <div class="">
...
<option value='undefined'>undefined</option> 
                     ...
                     <div class="form-group">
                      ...
                      <input type="text" class="form-control" value="<?php echo $row['business_pin']; ?>" name="pin" pattern="[0-9]{6}"  required  title="Please enter your correct PIN" >
                    </div>
                    ...
                    <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <textarea name="address" class="form-control" rows="5" required><?php echo $row['business_address']; ?></textarea>
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="form-group">
                            <label class="bmd-label-floating">  </label>
                            <textarea name="caption" class="form-control" rows="5" required><?php echo $row['business_caption']; ?></textarea>
                          </div>
                        </div>
            ...
            <div class="col-md-4">
              <div class="card ">
                <div class="card-header card-header-rose card-header-icon">
                  ...
                  <h4 class="card-title">User Details <span style="color:red;">* are required fields</span></h4>
                </div>
                <div class="card-body ">
              ...
              <div class="card ">
                ...
                <div class="card-body ">
                    ...
                    <div class="form-group mt-4">
                      ...
                      <input type="number" class="form-control" id="custom_latitude" value="<?php echo $row['lat']; ?>" >
                    </div>
                    <div class="form-group">
                      <label for="">Longitude </label>
                      <input type="number" class="form-control" id="custom_longitude" value="<?php echo $row['lng']; ?>" >
                    </div>
            ...
            <div class="col-md-4">
                <div class="card card-profile">
                        <div class="card-header card-header-rose card-header-icon">
                            ...
                            <h4 class="card-title">Select Business Logo </h4>
                        </div>
                        <div class="card-body">
                 <div class="fileinput fileinput-new text-center" data-provides="fileinput">
                       <div class="fileinput-new thumbnail">
                         <img src="../vendor_app/uploads/logo/<?php echo $row['logo']; ?>" alt="...">
                       </div>
                       ...
                       <div>
                         ...
                         <span class="btn btn-rose btn-round btn-file">
                           ...
                           <input type="hidden" name="pre-profile-pic" value="<?php echo $row['logo']; ?>" />
                         </span>
            ...
            <div class="col-md-4">
                <div class="card card-profile">
                        <div class="card-header card-header-rose card-header-icon">
                            ...
                            <h4 class="card-title">Availability Settings </h4>
                        </div>
                        <div class="card-body">
            
                      
                         <div class="form-group">
                            <label for="">Select Availability <span style="color:red;">*</span></label>
                            <select class="form-control" name="is_available" value="<?php echo $row['is_available']; ?>"  required>
                                <option value="0" <?php if($row['is_available'] == 0){ echo "selected"; } ?> >Unavailable</option>
            ...
            <div class="col-md-12">
                <div class="card ">
                    <div class="card-footer">
                          <button disabled id="edit-vendor" name="edit-vendor" type="submit" class="btn btn-fill btn-rose btn-block">Update Vendor</button>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-12">
                <div class="card ">
                    <div class="card-footer">
                          <button  type="button" onclick="confirmDeleteModal(<?php echo $row['id']; ?>);" class="btn btn-fill btn-rose btn-block" style="background:red;" > <i class="material-icons">close</i> Delete Vendor</button>
                    </div>
                </div>
            </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <a class="btn btn-danger" id="del_link" href="all-vendors.php?delvendor">Yes, Delete</a>
      </div>
...
function confirmDeleteModal(vendorid)
{
    $('#deleteModal').modal('show');
    $('#del_link').attr("href", "all-vendors.php?delvendor="+vendorid);
...
document.querySelector('#city').value="<?php echo $row['business_city']; ?>";
...
var myLatlng = new google.maps.LatLng(mylat,mylong);
  ...
  var map=new google.maps.Map(document.getElementById("googleMap"), mapProp);
    ...
    $('#edit-vendor').removeAttr("disabled");
    // marker drag event
