...
<body class="fixed-bottom-bar">
        ...
        <div class="p-3 bg-primary bg-primary mt-n3 rounded position-relative">
            <div class="d-flex align-items-center">
                <div class="feather_icon">
                    <a <?php if($restaurant_data['bf_list'] != 1) { echo "style='display:none;' "; } ?> onclick="showMenuTab('#breakfast', 'bf_img')" class="text-decoration-none text-dark"><img id="bf_img" src="img/icons/morning.png" style="width:15%;" /></a>
                    <a <?php if($restaurant_data['lun_list'] != 1) { echo "style='display:none;' "; } ?> onclick="showMenuTab('#lunch', 'lun_img')" class="text-decoration-none text-dark mx-2"><img id="lun_img" src="img/icons/noon.png" style="width:15%;" /></a>
                    <a <?php if($restaurant_data['din_list'] != 1) { echo "style='display:none;' "; } ?> onclick="showMenuTab('#dinner', 'din_img')" class="text-decoration-none text-dark"><img id="din_img" src="img/icons/night.png" style="width:15%;" /></a>
                </div>
                <button data-toggle="modal" data-target="#locationModal" class="btn btn-sm btn-warning ml-auto"> CONTACT</button>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-md-3 mb-3">
                    <ul class="nav nav-tabsa custom-tabsa border-0 flex-column bg-white rounded overflow-hidden shadow-sm p-2 c-t-order" id="myTab" role="tablist">
                        <li <?php if($restaurant_data['bf_list'] != 1) { echo "style='display:none;' "; } ?>  class="nav-item" role="presentation">
                            <a class="nav-link border-0 text-dark py-3" id="bf-tab" data-toggle="tab" href="#breakfast" role="tab" aria-controls="breakfast" aria-selected="true">
                                <div class="mr-2 text-success mb-0"><img src="img/icons/morning.png" style="width:30%;" /></div> Breakfast Items</a>
                        </li>
                        <li <?php if($restaurant_data['lun_list'] != 1) { echo "style='display:none;' "; } ?> class="nav-item border-top" role="presentation">
                        ...
                        <li <?php if($restaurant_data['din_list'] != 1) { echo "style='display:none;' "; } ?>  class="nav-item border-top" role="presentation">
                ...
                <div class="tab-content col-md-9 bg-white rounded px-2 pb-2" style="width: 96%; margin-left: 6px;" id="myTabContent">
                    ...
                    <div <?php if($restaurant_data['bf_list'] != 1) { echo "style='display:none;' "; } ?> class="tab-pane fade show active" id="breakfast" role="tabpanel" aria-labelledby="bf-tab">
                        <div class="order-body">
                            <div class="pb-3">
                                <div class="container">
                                    <div class="">
                                        <p class="font-weight-bold py-3 m-0">BREAKFAST ITEMS <span class="float-right text-danger" onclick="serveDetail('breakfast')">View All</span></p>
                                        <!-- slider -->
                                        <div class="weekly-slider rounded">
                            ...
                            <?php if($restaurant_data['is_available'] == 1) { ?>
                            
                        <a href="res_select_plan.php?serve=breakfast&username=<?php echo $_GET['username']; ?>&restaurant=<?php echo $restaurant; ?>" class="btn btn-success btn-block btn-lg text-white" >CHOOSE YOUR PLAN <i class="feather-arrow-right ml-2"></i></a>

                            <?php } else { ?>
                            
                                                    <a href="javascript:;" onclick="alert('Not available to take orders.');" class="btn btn-success btn-block btn-lg text-white" >CHOOSE YOUR PLAN <i class="feather-arrow-right ml-2"></i></a>
                    ...
                    <div <?php if($restaurant_data['lun_list'] != 1) { echo "style='display:none;' "; } ?> class="tab-pane fade <?php if($restaurant_data['bf_list'] != 1) { echo "show active "; } ?> " id="lunch" role="tabpanel" aria-labelledby="lun-tab">
                        <div class="order-body">
                            <div class="pb-3">
                                <div class="container">
                                    <div class="">
                                        <p class="font-weight-bold py-3 m-0">LUNCH ITEMS <span class="float-right text-danger" onclick="serveDetail('lunch')">View All</span></p>
                                        <!-- slider -->
                                        <div class="weekly-slider rounded">
                                                ...
                                                <div class="row">
                                                    <div class="col-4 d-flex justify-content-center align-items-center">
                                                        <div>
                                                            <b>7 Meals</b>
                                                            <br/>
                                                             <?php echo $lun_package_tot/7; ?>/Meal
                                                        </div>
                                                    </div>
                                                    <div class="col-8">
    ...
    <a href="res_select_plan.php?serve=lunch&username=<?php echo $_GET['username']; ?>&restaurant=<?php echo $restaurant; ?>" class="btn btn-success btn-block btn-lg text-white" >CHOOSE YOUR PLAN <i class="feather-arrow-right ml-2"></i></a>
                    ...
                    <div <?php if($restaurant_data['din_list'] != 1) { echo "style='display:none;' "; } ?> class="tab-pane fade <?php if($restaurant_data['bf_list'] != 1 && $restaurant_data['lun_list'] != 1) { echo "show active "; } ?> " id="dinner" role="tabpanel" aria-labelledby="din-tab">
                        <div class="order-body">
                            <div class="pb-3">
                                <div class="container">
                                    <div class="">
                                        <p class="font-weight-bold py-3 m-0">DINNER ITEMS <span class="float-right text-danger" onclick="serveDetail('dinner')">View All</span></p>
                                        <!-- slider -->
                                        <div class="weekly-slider rounded">
                                                ...
                                                <div class="row">
                                                    <div class="col-4 d-flex justify-content-center align-items-center">
                                                        <div>
                                                            <b>7 Meals</b>
                                                            <br/>
                                                             <?php echo $din_package_tot/7; ?>/Meal
                                                        </div>
                                                    </div>
                                                    <div class="col-8">
...
<?php if($restaurant_data['is_available'] == 1) { ?>
    ...
    <a href="res_select_plan.php?serve=dinner&username=<?php echo $_GET['username']; ?>&restaurant=<?php echo $restaurant; ?>" class="btn btn-success btn-block btn-lg text-white" >CHOOSE YOUR PLAN <i class="feather-arrow-right ml-2"></i></a>
        ...
        <div class="modal-dialog modal-dialog-scrollable">
          ...
          <div class="modal-content">
            ...
            <form action="" method="post" id="orderForm" >
                ...
                <!--div class="d-flex border-bottom osahan-cart-item-profile bg-white p-3">
                    <div class="d-flex flex-column">
                        <h6 class="mb-1 font-weight-bold"><?php echo $restaurant_data['business_name']; ?></h6>
                        <p class="mb-0 small text-muted"><i class="feather-map-pin"></i> <?php echo $restaurant_data['business_address'].", ".$restaurant_data['business_city']; ?></p>
                    </div>
                </div-->
                ...
                <div class="bg-white p-3 py-3 border-bottom clearfix">
                    ...
                    <div class="form-group">
                      ...
                      <div id="googleMap" style="height: 180px;"></div>
                      ...
                      <div class="mt-3 mb-0 input-group">
                        ...
                        <textarea required placeholder="Enter Full Delivery Address" name="delivery_address" aria-label="With textarea" class="form-control"></textarea>
                      </div>
                      
                      <div class="mt-3 mb-0 input-group">
                        <div class="input-group-prepend"><span class="input-group-text"><i class="feather-map-pin"></i></span></div>
                        <textarea required placeholder="Enter Delivery Address Landmark" name="delivery_landmark" aria-label="With textarea" class="form-control"></textarea>
                      </div>
