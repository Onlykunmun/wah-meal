...
/**
 * @author Amaresh Parida <amresh.parida10000@gmail.com>
 * @copyright Wah Meal 2021
 * @package wah_meal_restaurant
 * 
 * 
...
$config["abs_url_images"] 		= "https://www.wahmeal.in/vendor_app//media/image/" ; 		//Absolute Images URL
$config["abs_url_videos"] 		= "https://www.wahmeal.in/vendor_app//media/media/" ; 		//Absolute Videos URL
$config["abs_url_audios"] 		= "https://www.wahmeal.in/vendor_app//media/media/" ; 		//Absolute Audio URL
$config["abs_url_files"] 		= "https://www.wahmeal.in/vendor_app//media/file/" ; 		//Absolute Files URL
...
switch($_GET["json"]){	
	...
	case "auth":
		...
		if(isset($_SERVER["PHP_AUTH_USER"])){
			...
			$auth_sql = "SELECT * FROM `vendors` WHERE `email` = '$php_auth_user' AND `password` = '$php_auth_pw'";
			if($result = $mysql->query($auth_sql)){
				$current_user = $result->fetch_array();
	...
	case "route":		$rest_api=array();
		$rest_api["site"]["name"] = "Wah Meal Restaurant" ;
		$rest_api["site"]["description"] = "Wah Meal Restaurant" ;
