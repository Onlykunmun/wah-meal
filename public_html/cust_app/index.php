...
if(!isset($_GET['servetime']))
{
    ...
    if($foodServe == "lun")
    {
        header('Location: index-lunch.php?username='.$_GET['username']);
    }
    else if($foodServe == "din")
    {
        header('Location: index-dinner.php?username='.$_GET['username']);
    }
}
...
<body class="fixed-bottom-bar">
        ...
        <div class="topnav fixed-top" style="margin-top: 4rem!important;">
            <a class="active" href="index.php?username=<?php echo $_GET['username']; ?>&servetime=false">Breakfast</a>
            <a href="index-lunch.php?username=<?php echo $_GET['username']; ?>">Lunch</a>
