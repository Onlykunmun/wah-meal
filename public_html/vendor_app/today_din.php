...
?>
    ...
    <div class="app-wrapper mt-5">
	    ...
	    <div class="app-content ">
	           ...
	           <nav style="background:#fff; margin-top: 55px;" class="mb-2 fixed-top navbar navbar-expand bg-light navbar-light justify-content-center">
  <ul class="navbar-nav">
    <li class="nav-item px-3">
      <a class="nav-link" href="index.php"><b>Breakfast</b></a>
    </li>
    <li class="nav-item px-3">
      <a class="nav-link" href="today_lun.php"><b>Lunch</b></a>
    </li>
    <li class="nav-item px-3 active">
      <a class="nav-link" href="today_din.php"><b>Dinner</b></a>
    </li>
  </ul>
</nav>
...
$sql = "SELECT fps.*, fi.food_name, fi.food_price , fi.food_type as f_type FROM order_subscription as os LEFT JOIN food_processing_status fps ON os.id = fps.food_order_id LEFT JOIN food_items fi ON fps.food_id = fi.id WHERE os.accept_reject = '1' AND fps.for_date = '".$for_date."' AND os.vendor_id = ".$_SESSION["userdata"]["id"]." AND os.serve_time = 3 ORDER BY os.id ASC ";
