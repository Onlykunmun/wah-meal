				        ...
				        <div class="app-card app-card-chart h-100 shadow-sm">
					        <div class="app-card-header p-3">
						        <div class="row justify-content-between align-items-center">
							        <div class="col-auto">
						                <h4 class="app-card-title"><span class="badge bg-success">Completed Subscription <span class="badge bg-danger"><?php echo $completed_subscription; ?></span></span> </h4> 
							        </div><!--//col-->
...
$sql_subscription = "SELECT * FROM order_subscription WHERE vendor_id = '".$_SESSION["userdata"]["id"]."' AND is_paid = 1 AND accept_reject = 1 AND end_date < '$date_of_today' ORDER BY subscription_date DESC ";
if($result_subscription = $conn->query($sql_subscription))
{
while($row_subscription = $result_subscription->fetch_assoc()) {
